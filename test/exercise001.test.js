import { capitalize, generateInitials, addVAT, getSalePrice, getMiddleCharacter, reverseWord, reverseAllWords, countLinuxUsers, getMeanScore, simpleFizzBuzz } from '../challenges/exercise001';
...
describe('reverseAllWords', () => {
  ...
  test('reverses a multiple words in an array', () => {
    expect(reverseAllWords(['jest', 'mocha', 'rspec', 'jasmine', 'selenium'])).toEqual(['tsej', 'ahcom', 'cepsr', 'enimsaj', 'muineles']);
  });
});
