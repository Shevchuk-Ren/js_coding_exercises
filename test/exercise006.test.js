import { areWeCovered, sumMultiples, isValidDNA, getComplementaryDNA, isItPrime, createMatrix } from '../challenges/exercise006';
...
describe('createMatrix', () => {
  test('Returns an array of n arrays, each filled with n items. The parameter fill should be used as the filler of the arrays.', () => {
    ...
    expect(createMatrix(1, 'cat')).toEqual([['cat']]);
  });
});
