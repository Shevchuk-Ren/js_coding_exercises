import { getFillings, isFromManchester, getBusNumbers, countSheep, hasMPostCode } from '../challenges/exercise002';
...
describe('countSheep', () => {
  ...
  test('returns 5 if there are 5 sheep in the array', () => {
    const arr = ['dog', 'sheep', 'dog', 'sheep', 'chicken', 'sheep', 'hare', 'sheep', 'sheep'];
